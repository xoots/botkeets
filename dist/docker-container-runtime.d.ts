...
export declare class DockerContainerRuntime implements ContainerRuntime {
    ensureRunning(): void;
...
export declare const dockerContainerRuntime: DockerContainerRuntime;
//# sourceMappingURL=docker-container-runtime.d.ts.map