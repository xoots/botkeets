import { getToolPolicy, type ToolPolicy } from './dangerous-tools.js';
...
export function normalizeToolPolicyMode(mode: string | undefined): SandboxToolPolicyMode {
  if (mode === 'chat-only') return 'chat-only';
